...
const char* GetLunarMonthStr(uint8_t month, uint8_t lang);
const char* GetLunarMonthLeapStr(uint8_t isLeap, uint8_t lang);
const char* GetLunarDateStr(uint8_t date, uint8_t lang);
const char* GetLunarDayStr(uint8_t day, uint8_t lang);
const char* GetLunarZodiacStr(uint8_t zodiac, uint8_t lang);
const char* GetLunarStemStr(uint8_t stem, uint8_t lang);
const char* GetLunarBranchStr(uint8_t branch, uint8_t lang);
